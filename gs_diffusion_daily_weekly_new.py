...
if __name__ == "__main__":
    ...
    logging.basicConfig(level=logging.DEBUG, filename="logfile_daily_weekly_new", filemode="a+", format="%(asctime)-15s %(levelname)-8s %(message)s")
    ...
    # RUN ON Days range
        for day in daysList:
            ...
            savelocation = "/local/scratch/exported/blockchain_parsed/bitcoin_darknet/gs_group/grayscale_op_ali/heur_1_data_final_daily_weekly_new/daily/"
        ...
        savelocation = "/local/scratch/exported/blockchain_parsed/bitcoin_darknet/gs_group/grayscale_op_ali/heur_1_data_final_daily_weekly_new/weekly/"
